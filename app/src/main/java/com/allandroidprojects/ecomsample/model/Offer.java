...
public class Offer extends SuperClass {
    ...
    public Offer()
    {
        ...
        offers.add(new Word("Sewing Machine", "Brother Sewing Machine, XM2701, Lightweight Sewing Machine with 27 Stitches powered by addition", "$ 431.8"));
        offers.add(new Word("White Lamp", "Modernluci Wall Sconce LED Wall Light Modern Plug in Bedroom Lamp Dark Grey", "$ 91.8"));
        offers.add(new Word("Camera", "Kodak PIXPRO Astro Zoom AZ401-BK 16MP Digital Camera with 40X Optical Zoom and", "$ 720.8"));
